...
router.get('/events/:eventId/sessions', authenticateToken, requireAdmin, getSessionsByEventId);//get all sessions for an event
router.get('/events/:eventId/sessions/export', authenticateToken, requireAdmin, exportAttendanceSessionsToExcel);//export all sessions for an event
